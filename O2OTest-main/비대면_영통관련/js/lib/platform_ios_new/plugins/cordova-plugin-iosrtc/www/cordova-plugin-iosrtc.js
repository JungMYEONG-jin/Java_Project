...
MediaStreamRenderer.prototype.refresh = function () {
	...
	// kswksk video 추가
	/*****************************************/
	var spassPosition = "back";
	if (this.element.hasAttribute('spassposition')) {
		spassPosition = this.element.getAttribute("spassposition");
	}
	
	if (spassPosition != "front") {
		spassPosition = "back";
	}
	
	var spassTopStatusBar = "false";
	if (this.element.hasAttribute('spasstopstatusbar')) {
		spassTopStatusBar = this.element.getAttribute("spasstopstatusbar");
	}
	...
	function nativeRefresh() {
		var data = {
				...
				// kswksk video 추가
				/*****************************************/
				, spassPosition: spassPosition
				, spassTopStatusBar: spassTopStatusBar
			},
