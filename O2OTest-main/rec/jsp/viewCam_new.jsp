...
<head>
	...
	<script src="/public/resources/spass_common/lib/adapter-latest.js?a=<%=ts%>"></script>
	<script src="/public/resources/spass_common/lib/drawPen-lib-1.0.0.js?a=<%=ts%>"></script>
	<script src="/public/resources/spass_common/lib/sframe-utils-1.0.0.js?a=<%=ts%>"></script>
	<script src="/public/resources/spass_common/lib/sframe-chat-1.0.0.js?a=<%=ts%>"></script>
	<script src="/public/resources/spass_common/lib/getStats.min.js?a=<%=ts%>"></script>
	<script src="/public/resources/spass_common/lib/spass-log-lib-1.0.0.js?a=<%=ts%>"></script>
	<script src="/public/resources/spass_common/lib/spass-lib-1.1.0.js?a=<%=ts%>"></script>
	<script src="/public/resources/spass_common/lib/html2canvas.js?a=<%=ts%>"/></script>
	<script src="/public/resources/spass_common/lib/html2canvas.min.js?a=<%=ts%>"/></script>
	<script src="/public/resources/pc/js/viewCam_new.js?a=<%=ts%>"></script>
</head>
